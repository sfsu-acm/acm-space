...
export default function Home() {
  ...
  }, [currentIndex, isDeleting, typedText, headerText])
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      <CanvasSquircles />
      {/* Hero Section */}
      <section className="container mx-auto px-4 py-20 flex flex-col items-center justify-center min-h-[100vh] relative">
        ...
        <p className="text-lg font-medium md:text-xl text-gray-600 text-center mb-5 md:mb-12 max-w-4xl">
        ...
        <div className="absolute bottom-20 md:bottom-6 left-0 right-0 w-full">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              ...
              <p className="text-gray-600">A community of computer science students, built with love and passion for all things fun and computers.</p>
            </div>
